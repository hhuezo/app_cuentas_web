    ...
    <div class="2xl:col-span-12 lg:col-span-12 col-span-12">
        <div class="card">
            ...
            <div class="card-body flex flex-col p-6">
                <form method="POST" action="{{ route('persona_web.update', $persona->id) }}">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="banco" class="form-control" value="{{ $persona->banco }}">
                        </div>


                        <div class="col-md-6 mb-3">
                            <label for="largeInput" class="form-label">Cuenta</label>
                            <input type="text" name="cuenta" class="form-control" value="{{ $persona->cuenta }}">
                        </div>
