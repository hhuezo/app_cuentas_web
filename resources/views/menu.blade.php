                ...
                <ul class="metismenu" id="menu">
                    ...
                    @can('administracion')
                        <li><a class="has-arrow " aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="{{ url('catalogos/unidad_laboral') }}">Unidad Laboral</a></li>
                    ...
                    <li><a href="{{ url('prestamo_web') }}" class="" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><a href="{{ url('prestamo_fijo_web') }}" class="" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="nav-text">Prestamos fijos</span>
                        </a>


                    </li>

                    <li><a href="{{ url('persona_web') }}" class="" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_113_177)">
                    ...
                    @can('catalogos')
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="{{ url('catalogos/atencion_cliente') }}">Atencion al Cliente</a></li>
                                <li><a href="{{ url('catalogos/lugar_origen') }}">Lugar de Origen</a></li>
                                <li><a href="{{ url('catalogos/empresa') }}">Empresa</a></li>
                                <li><a href="{{ url('catalogos/tipo_documento') }}">Tipo de Documento</a></li>
                                <li><a href="{{ url('catalogos/estado_ticket') }}">Estado Ticket</a></li>
                                <li><a href="{{ url('catalogos/escritorio') }}">Escritorio</a></li>
                                <li><a href="{{ url('administracion/colas') }}">Cola</a></li>
                            </ul>
                        </li>
                    @endcan
